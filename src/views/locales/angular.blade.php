...
@section('page-title') <h3><i class="fa fa-language"></i> Languages</h3> @stop

@section('page')

    <div data-ng-app="localesApp" data-ng-controller="LocalesController" data-ng-init="laravel_token = '<?= csrf_token(); ?>'">
        <div data-ui-view="">
...
@section('page-js')
    ...
    {!! HTML::script('packages/kjamesy/cms/angular-scripts/locales.app.js') !!}
    {!! HTML::script('packages/kjamesy/cms/angular-scripts/locales.controllers.js') !!}
    {!! HTML::script('packages/kjamesy/cms/angular-scripts/locales.services.js') !!}
