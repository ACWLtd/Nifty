...
@section('page')
    ...
    <div data-ng-app="pagesApp" data-ng-controller="PagesController" data-ng-init="laravel_token = '<?= csrf_token(); ?>'">
        <div data-ui-view="">
...
@section('page-js')
    ...
    {{ HTML::script('packages/kjamesy/cms/angular-scripts/pages.app.js') }}
    {{ HTML::script('packages/kjamesy/cms/angular-scripts/pages.controllers.js') }}
    {{ HTML::script('packages/kjamesy/cms/angular-scripts/pages.services.js') }}
